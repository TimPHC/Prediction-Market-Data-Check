...
# Root directory is one level up from script location
...
def main():
    # Load data from script's directory
    json_path = os.path.join(SCRIPT_DIR, "kalshi_volume_data.json")
    ...
    # Save to root directory (one level up)
